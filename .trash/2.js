            ...
            for (const [path, group] of materialEntries)
            {
                ...
                // Split by Direction
                {
                    ...
                    for (let vi = 0; vi < vertCount; vi += 3)
                    {
                        ...
                        if (isPosX)       { coveredFaces[0]++; groups[1].push(x0,y0,z0,x1,y1,z1,x2,y2,z2); if (hasUV) groupUVs[1].push(uvArray[vi*2],uvArray[vi*2+1],uvArray[vi*2+2],uvArray[vi*2+3],uvArray[vi*2+4],uvArray[vi*2+5]); }
                        else if (isNegX)  { coveredFaces[1]++; groups[2].push(x0,y0,z0,x1,y1,z1,x2,y2,z2); if (hasUV) groupUVs[2].push(uvArray[vi*2],uvArray[vi*2+1],uvArray[vi*2+2],uvArray[vi*2+3],uvArray[vi*2+4],uvArray[vi*2+5]); }
                        else if (isPosY)  { coveredFaces[2]++; groups[3].push(x0,y0,z0,x1,y1,z1,x2,y2,z2); if (hasUV) groupUVs[3].push(uvArray[vi*2],uvArray[vi*2+1],uvArray[vi*2+2],uvArray[vi*2+3],uvArray[vi*2+4],uvArray[vi*2+5]); }
                        else if (isNegY)  { coveredFaces[3]++; groups[4].push(x0,y0,z0,x1,y1,z1,x2,y2,z2); if (hasUV) groupUVs[4].push(uvArray[vi*2],uvArray[vi*2+1],uvArray[vi*2+2],uvArray[vi*2+3],uvArray[vi*2+4],uvArray[vi*2+5]); }
                        else if (isPosZ)  { coveredFaces[4]++; groups[5].push(x0,y0,z0,x1,y1,z1,x2,y2,z2); if (hasUV) groupUVs[5].push(uvArray[vi*2],uvArray[vi*2+1],uvArray[vi*2+2],uvArray[vi*2+3],uvArray[vi*2+4],uvArray[vi*2+5]); }
                        else if (isNegZ)  { coveredFaces[5]++; groups[6].push(x0,y0,z0,x1,y1,z1,x2,y2,z2); if (hasUV) groupUVs[6].push(uvArray[vi*2],uvArray[vi*2+1],uvArray[vi*2+2],uvArray[vi*2+3],uvArray[vi*2+4],uvArray[vi*2+5]); }
                        else
                        {
                            groups[0].push(x0,y0,z0,x1,y1,z1,x2,y2,z2);
