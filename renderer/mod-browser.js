...
[
    ...
    },
    {
        ...
        deselect: () => { if(sourceFilter.find(e=>e=='planetMinecraft')){delete sourceFilter[sourceFilter.findIndex(e=>e=='planetMinecraft')];displayResult()} }
    },
    {
        select: () => { if(!sourceFilter.find(e=>e=='minecraftMods')){sourceFilter.push('minecraftMods');displayResult()} },
        deselect: () => { if(sourceFilter.find(e=>e=='minecraftMods')){delete sourceFilter[sourceFilter.findIndex(e=>e=='minecraftMods')];displayResult()} }
    }
], 0, true, true);
